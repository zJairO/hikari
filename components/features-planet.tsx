        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-white md:text-4xl">
              Optimiza tu negocio con nuestras soluciones digitales
            </h2>
          </div>
          {/* Planet */}
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-primary-500 before:to-primary-200/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.primary.500),transparent)]">
                <Image
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Con herramientas más rápidas y funcionales, tu equipo puede concentrarse en tareas estratégicas y obtener mejores resultados en menos tiempo.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Reduce tareas manuales repetitivas con herramientas digitales que gestionan flujos de trabajo automáticamente, ahorrando tiempo y esfuerzo.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Datos y reportes</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Accede a informes, análisis y datos en tiempo real, lo que te permite tomar decisiones informadas de manera rápida y eficiente.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Con un sistema web o móvil, tu negocio está disponible 24/7 para ti y tu equipo, sin importar dónde se encuentren.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                A medida que tu empresa crece, las soluciones digitales se adaptan fácilmente a nuevas necesidades, permitiéndote expandir operaciones sin complicaciones.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Un sistema eficiente disminuye gastos asociados a procesos manuales, errores y tiempos muertos.
              </p>
            </article>
          </div>
        </div>
